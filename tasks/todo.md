...
- 963/963 workspace Rust tests at v60.9 (737 atelier-core unit + 45 atelier-cli unit + 61 atelier-cli integration + 28 atelier-gui + 92 atelier-tui). Trail: v54 506 → v60.5 755 → v60.6 788 → v60.7 861 → v60.8 928 → v60.9 963; per-version test counts live in `CHANGELOG.md`
