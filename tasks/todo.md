...
- 974/974 workspace Rust tests at v60.10 (746 atelier-core unit + 45 atelier-cli unit + 63 atelier-cli integration + 2 atelier-cli mcp_integration + 28 atelier-gui + 92 atelier-tui; 2 `#[ignore]`-gated). Trail: v54 506 → v60.5 755 → v60.6 788 → v60.7 861 → v60.8 928 → v60.9 963 → v60.10 974; per-version test counts live in `CHANGELOG.md`
